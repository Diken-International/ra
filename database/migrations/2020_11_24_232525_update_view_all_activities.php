...
class UpdateViewAllActivities extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Illuminate\Support\Facades\DB::statement('DROP VIEW IF EXISTS all_activities');
       ...
       (select name from users where id = union_data.technical_id) as technical_name
        FROM (
            SELECT
                   ...
                   todos.kms as kms,
                   todos.performance as performance,
            ...
            SELECT services.id as id,
                   ...
                   services.kms as kms,
                   services.performance as performance,
