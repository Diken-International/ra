...
class UpdateViewServicesReport extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       ...
       (select count(rp.id) from report_services as rp where rp.product_user_id = product_user.id )              as number_services,
