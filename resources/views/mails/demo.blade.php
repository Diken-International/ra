                                                    ...
                                                    <table>
                                                        ...
                                                        <th class="small-12 large-6 columns last">
                                                            <table>
                                                                <tbody>
                                                                <tr>
                                                                    <th> {{ \Carbon\Carbon::parse($service['created_at'])->diffForHumans() }} </th>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </th>
                                                    ...
                                                    <table>
                                                        ...
                                                        <th class="small-12 large-6 columns last">
                                                            <table>
                                                                <tbody>
                                                                <tr>
                                                                    <th> {{ ($service['activity'] == 'preventive') ? 'Preventivo' : 'Correctivo' }} </th>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </th>
                                                    ...
                                                    <table>
                                                        ...
                                                        <th class="small-12 large-6 columns last">
                                                            <table>
                                                                <tbody>
                                                                <tr>
                                                                    <th> {{ ($service['type'] == 'remote') ? 'Remoto' : 'Presencial' }} </th>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                        </th>
                                                    ...
                                                    <table>
                                                        <th class="small-12 large-6 columns first last">
                                                            <table>
                                                                <tbody>
                                                                <tr>
                                                                    <th>Con el fin de mejorar nuestro servicio, te invitamos a llenar nuestra encuesta del servicio.</th>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td>
                                                                                                                <table>
                                                                                                                    <tbody>
                                                                                                                    <tr>
                                                                                                                        <td><a align="center" href="{{ $url  }}">Llenar encuesta de servicio</a></td>
                                                                                                                    </tr>
                                                                                                                    </tbody>
                                                                                                                </table>
                                                                                                            </td>
